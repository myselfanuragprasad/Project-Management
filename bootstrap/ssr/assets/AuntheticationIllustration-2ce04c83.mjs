...
import { A as ApplicationLogo, _ as _sfc_main$2 } from "./SwitchLangNavbar-dc6a22d1.mjs";
import { Link } from "@inertiajs/vue3";
import { _ as _sfc_main$3 } from "./SwitchDarkMode-80e1266e.mjs";
const _sfc_main$1 = {
  __name: "GuestLayout",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex flex-col-2 sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900 text-gray-500 dark:text-gray-300" }, _attrs))}><div class="w-full sm:max-w-md lg:max-w-4xl my-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg"><div class="grid grid-cols-1 lg:grid-cols-2"><div class="space-y-6 px-6 py-4 lg:py-16"><div class="flex justify-between items-center">`);
...
const _sfc_main = {
  __name: "AuntheticationIllustration",
  __ssrInlineRender: true,
  props: {
    type: String
  },
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/AuntheticationIllustration.vue");
