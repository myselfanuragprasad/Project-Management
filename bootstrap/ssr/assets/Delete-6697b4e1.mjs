...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    const destory = () => {
      var _a;
      form.delete(route("user.destroy", (_a = props.user) == null ? void 0 : _a.id), {
        preserveScroll: true,
        onSuccess: () => {
          emit("close");
          form.reset();
