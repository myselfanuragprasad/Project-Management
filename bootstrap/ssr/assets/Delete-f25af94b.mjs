...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    const destory = () => {
      var _a;
      form.delete(route("client.destroy", (_a = props.client) == null ? void 0 : _a.id), {
        preserveScroll: true,
        onSuccess: () => {
          emit("close");
          form.reset();
            ...
            return [
              createVNode("form", {
                ...
                createVNode("p", { class: "mt-1 text-sm text-gray-600 dark:text-gray-400" }, [
                  ...
                  createVNode("b", null, toDisplayString((_b = props.client) == null ? void 0 : _b.name), 1),
                  createTextVNode("? ")
                ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Client/Delete.vue");
