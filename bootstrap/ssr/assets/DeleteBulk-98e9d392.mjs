...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    const destory = () => {
      form.post(route("client.destroy-bulk"), {
        preserveScroll: true,
        onSuccess: () => {
          emit("close");
          form.reset();
          ...
          if (_push2) {
            ...
            return [
              createVNode("form", {
                ...
                createVNode("p", { class: "mt-1 text-sm text-gray-600 dark:text-gray-400" }, toDisplayString(_ctx.lang().label.delete_confirm) + " " + toDisplayString((_b = props.selectedId) == null ? void 0 : _b.length) + " " + toDisplayString(props.title) + "? ", 1),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Client/DeleteBulk.vue");
