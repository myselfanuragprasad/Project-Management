import { watch, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    const update = () => {
      var _a;
      form.put(route("client.update", (_a = props.client) == null ? void 0 : _a.id), {
        preserveScroll: true,
        onSuccess: () => {
          emit("close");
          form.reset();
    ...
    watch(() => props.show, (newValue) => {
      ...
      if (newValue) {
        form.errors = {};
        form.client_name = ((_a = props.client) == null ? void 0 : _a.client_name) || "";
        form.client_id = ((_b = props.client) == null ? void 0 : _b.client_id) || "";
        form.client_erp_id = ((_c = props.client) == null ? void 0 : _c.client_erp_id) || "";
      } else {
        form.reset();
      }
    }, { immediate: true });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="p-6"${_scopeId}><h2 class="text-lg font-medium text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(_ctx.lang().label.edit)} ${ssrInterpolate(props.title)}</h2><div class="my-6 space-y-4"${_scopeId}><div${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Client/Edit.vue");
