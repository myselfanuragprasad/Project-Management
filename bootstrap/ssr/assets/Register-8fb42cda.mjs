        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), {
              title: _ctx.lang().label.register
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.lang().label.registered)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.lang().label.registered), 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_sfc_main$6, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(form).processing ? _ctx.lang().button.register + "..." : _ctx.lang().button.register)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(form).processing ? _ctx.lang().button.register + "..." : _ctx.lang().button.register), 1)
                  ];
                }
              }),
              _: 1
